...
-- This uses Quickshell's IPC (Inter-Process Communication) to tell the background Noctalia service to toggle its launcher.
...
-- Move the active window to the special workspace
